...
<style>
    ...
    @media (max-width:768px){
        ...
        .header-section { flex-direction: column; align-items: center; gap: 1rem; }
        .get-started-btn-container { position: static; }
    }
</style>
...
<div class="header-section">
    <div class="title-section">
        <div class="page-title">🍋 Internship Hub</div>
        <div class="page-subtitle">Discover your perfect internship from top companies</div>
    </div>
